...
<nav class="sidebar">
  ...
  <a class="nav-link <?php echo e(Request::segment(1) == 'admin' ? 'active' : ''); ?>" href="<?php echo e(route('dashboard.admin')); ?>">
  ...
  <a class="nav-link <?php echo e(Request::segment(1) == 'user' ? 'active' : ''); ?>" href="<?php echo e(route('user.user')); ?>">
...
<main class="main-content">
  ...
  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Request::is('admin/dashboard')): ?>
    Admin
  <?php elseif(Request::is('user/profile')): ?>
    Profile
  <?php elseif(Request::is('user')): ?>
    Users
  <?php elseif(Request::is('booking/all')): ?>
    Bookings
  <?php elseif(Request::is('booking/add')): ?>
    Create Booking
  <?php elseif(Request::is('webpage')): ?>
    Webpages
  <?php else: ?>
    <?php echo e(ucfirst(Request::segment(2) ?? Request::segment(1))); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.baseview', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\KIIT\Desktop\INTERSHIP\WEB DEVELOPEMENT\PROJECTS\PROJECT3\bookingsms\resources\views/AdminDashboard/Layout/adminBaseView.blade.php ENDPATH**/ ?>