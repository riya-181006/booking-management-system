...
<?php $__env->startSection('dashContent'); ?>
    <div class="d-flex justify-content-end mb-3">
        <a href="<?php echo e(route('booking.add')); ?>" class="btn btn-primary">
    ...
    <div class="card" style="width:100%">
        <div class="card-body p-0">
            <table class="table table-hover mb-0" style="width:100%; table-layout:auto;">
                ...
                <tbody>
                    <?php $i = 1; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <tr>
                        ...
                        <td style="text-align:center">
                            <div class="action-dropdown">
                                ...
                                <div class="action-menu">
                                    <a href="<?php echo e(route('booking.edit', ['id' => $booking->id])); ?>" class="action-item">
                                    ...
                                    <a href="<?php echo e(route('booking.delete.view', ['id' => $booking->id])); ?>" class="action-item action-item-danger">
...
<?php echo $__env->make('UserDashboard.Layout.userBaseView', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\KIIT\Desktop\INTERSHIP\WEB DEVELOPEMENT\PROJECTS\PROJECT3\bookingsms\resources\views/UserDashboard/Bookings/index.blade.php ENDPATH**/ ?>