...
<?php $__env->startSection('title','BookEase'); ?>
...
<nav class="site-navbar">
  ...
  <ul class="nav-links">
    ...
    <li><a href="<?php echo e(url('page/'.$page->slug)); ?>" class="<?php echo e(Request::is('page/'.$page->slug) ? 'active' : ''); ?>"><?php echo e($page->name); ?></a></li>
...
<div class="page-banner">
  <div class="page-banner-inner">
    <div class="breadcrumb-custom">
      <a href="/">Home</a>
      <span>›</span>
      <span style="color:rgba(255,255,255,0.6);"><?php echo e(isset($data->name) ? $data->name : 'Page'); ?></span>
    </div>
    <h1><?php echo e(isset($data->name) ? $data->name : 'Welcome to <em>BookEase</em>'); ?></h1>
    <div class="page-banner-divider"></div>
  </div>
</div>
<div class="page-main">
  <div class="page-content-area">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($data->html)): ?>
      <?php echo $data->html; ?>
  ...
  <aside class="page-sidebar">
    <div class="sidebar-card">
      ...
      <ul class="sidebar-nav">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
        <li>
          <a href="<?php echo e(url('page/'.$page->slug)); ?>" class="<?php echo e(Request::is('page/'.$page->slug) ? 'active' : ''); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.baseview', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\KIIT\Desktop\INTERSHIP\WEB DEVELOPEMENT\PROJECTS\PROJECT3\bookingsms\resources\views/dynamic.blade.php ENDPATH**/ ?>